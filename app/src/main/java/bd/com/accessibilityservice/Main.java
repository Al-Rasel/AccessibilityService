...
/*        //Body of your click handler
    ...
    private static void show() {
       ...
       // boolean isCLiked2 = MainActivity.textView.dispatchTouchEvent(eventa2);
        ...
        //sh -c  "CLASSPATH=/data/app/bd.com.accessibilityservice-RJl6bOotLW8pEfdFi2LqNw==/base.apk /system/bin/app_process /system/bin bd.com.accessibilityservice.Main"
        // Toast.makeText(this, "sbow", Toast.LENGTH_SHORT).show();
    }
    private static void show2() {
        ...
        MotionEvent eventa2 = MotionEvent.obtain(SystemClock.uptimeMillis(), SystemClock.uptimeMillis(), MotionEvent.ACTION_UP, 1, pointerProperties, pointerCoords, 0, 0, 1, 1, 0, 0, 0, 0);
        //WindowManager windowmanager = (WindowManager) getSystemService(WINDOW_SERVICE);
        ...
        // injectionManager.injectTouchEventDown(482, 63);
        // injectionManager.injectTouchEventRelease(482, 63);
        System.out.print("event is clicked55" + isCLiked);
        //  Log.d("KIT", "event is clicked " + isCLiked);
        //   Log.d("KIT", "event is clicked " + isCLiked2);
